...
<div title=''>Set status:</div><div class='custom_mesg' id='custom_mesg'><input maxlength='18' type=text  id='custom_message_id'  /> <button onclick='FreiChat.freichatopt(\"nooptions\")'>&#10003;</button></div>\n\
...
$jn('#freicontain'+FreiChat.box_count).css("height",$jn('#frei_'+id).height());return FreiChat.box_count;};FreiChat.change_to_old_title=function(id)
...
/* Updated 25 October 2013 6:31 am FreiChatX  V.9.4 */